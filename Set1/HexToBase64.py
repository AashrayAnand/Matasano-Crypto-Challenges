...
output_ = 'SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t'
...
def hexToB64(input_):
    ...
    missingDigits = 6
    for hexChar in reversed(input_):
    ...
    return "".join(reversed(output_))

assert hexToB64(input_) == output_